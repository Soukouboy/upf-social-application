...
import type { LoginRequest, RegisterRequest, UserRole, AuthTokens, AuthUser } from '../types';
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
    ...
    const register = useCallback(async (payload: RegisterRequest): Promise<AuthUser> => {
        ...
        // Explicit login to obtain AuthTokens since register now returns StudentDetails
